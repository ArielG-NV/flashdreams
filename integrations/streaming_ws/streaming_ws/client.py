...
from streaming_ws.playout import PlayoutConfig, run_playout
from streaming_ws.protocol import pack_ctrl, unpack_frme
    ...
    *,
    ...
    async def on_frame(
        *,
        ...
        if cfg.show_window:
            from streaming_ws.opencv_viewer import show_webp_in_window
...
async def run_client(cfg: ClientConfig) -> dict[str, Any]:
    ...
    try:
        ...
        if cfg.show_window:
            from streaming_ws.opencv_viewer import destroy_viewer_window
