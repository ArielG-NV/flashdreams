...
AV_NEGATIVE_PROMPT = (
    "blurry, low quality, distorted, unrealistic, cartoon, anime, drawing, painting, "
    "overexposed, underexposed, artifacts, noise, text overlay, watermark"
)


def get_default_text_prompts(
    batch_size: int = 1,
    device: torch.device | str = "cuda",
    text_prompt: str = DEFAULT_POSITIVE_PROMPT,
) -> list[TextPrompt]:
    """Get default text prompts for demo purposes."""
    del device
