...
An alternative to :class:`omnidreams.interactive_drive.presenter.SlangPyPresenter` for
...
class MJPEGStreamingPresenter:
    ...
    :class:`omnidreams.interactive_drive.app.InteractiveDriveApp`: ``should_close`` /
