...
from torch.distributed import ProcessGroup, all_gather, all_gather_object, get_world_size
...
def split_inputs_cp_object_list(object_list: list[Any], cp_group: ProcessGroup) -> list[Any]:
    """
...
def cat_outputs_cp_object_list(object_list: list[Any], cp_group: ProcessGroup) -> list[Any]:
    """
