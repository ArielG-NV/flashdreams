...
Run on a GPU (typically inside an interactive srun)::
    ...
    PYTHONPATH=./flashsim python flashsim/tests/scheduler/_profile_scheduler.py
    PYTHONPATH=./flashsim python flashsim/tests/scheduler/_profile_scheduler.py --schedulers flow_match
    PYTHONPATH=./flashsim python flashsim/tests/scheduler/_profile_scheduler.py --n-repeat 50
...
from flashsim.infra.diffusion.scheduler import (
    FlowMatchScheduler,
