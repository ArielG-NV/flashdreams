...
Run on a GPU (typically inside an interactive srun)::
    ...
    PYTHONPATH=./flashsim python flashsim/tests/wanvae/_profile_wan_vae.py
    PYTHONPATH=./flashsim python flashsim/tests/wanvae/_profile_wan_vae.py --all-ckpts
    PYTHONPATH=./flashsim python flashsim/tests/wanvae/_profile_wan_vae.py --quick
...
_CACHE_ROOT = f"/tmp/{os.environ.get('USER', 'flashsim')}/wanvae_profile"
...
from flashsim.core.checkpoint.load import load_checkpoint  # noqa: E402
from flashsim.recipes.wan.autoencoder.vae import (  # noqa: E402
...
def _build_pair(
    ...
    *,
    ...
    targets = (
        ...
        "flashsim.recipes.wan.autoencoder.vae.load_checkpoint",
    )
