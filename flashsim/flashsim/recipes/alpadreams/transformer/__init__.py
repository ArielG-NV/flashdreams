...
:mod:`flashsim.infra.diffusion` interfaces.
...
from flashsim.recipes.wan.transformer.impl.rope import (
        ...
        **_unused: Any,
        ...
        Args:
            ...
            view_names: List of view names (length ``V``); required when
                ``num_views > 1``.
        """
        from flashsim.core.distributed.context_parallel import split_inputs_cp
