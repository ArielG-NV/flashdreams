...
from flashsim.core.distributed.context_parallel import cat_outputs_cp, split_inputs_cp
...
# python -m flashsim.recipes.alpadreams.transformer.impl.network --in-channels 3
