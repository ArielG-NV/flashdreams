...
from flashsim.recipes.lingbot_world.encoder.camctrl import (
    I2VCamCtrlEncoderConfig,
)
from flashsim.recipes.lingbot_world.transformer import (
    LingbotWorldTransformerConfig,
)
from flashsim.recipes.lingbot_world.transformer.impl.network import (
...
from flashsim.recipes.lingbot_world.pipeline import (
...
def _scheduler_config(
    ...
    :mod:`flashsim.recipes.wan.config.causal_wan21` does not apply
    here.
    """
