...
:mod:`flashsim.recipes.wan.config.causal_wan21`. Only T2V is supported
...
:data:`flashsim.recipes.wan.transformer.wan22.CHECKPOINT_KEY_MAPPING`.
...
from flashsim.core.checkpoint.remap import remap_checkpoint_keys
...
from flashsim.recipes.wan.pipeline import WanInferencePipelineConfig
from flashsim.recipes.wan.transformer.impl.network import (
    WanDiTNetwork14BConfig,
)
from flashsim.recipes.wan.transformer.wan21 import Wan21TransformerConfig
from flashsim.recipes.wan.transformer.wan22 import (
...
def build_fastvideo(
    *,
    ...
    :func:`flashsim.recipes.wan.config.causal_wan21.build_self_forcing`
