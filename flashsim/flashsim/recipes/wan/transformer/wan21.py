...
from flashsim.recipes.wan.autoencoder.i2v import I2VCtrl
...
class Wan21TransformerConfig(TransformerConfig):
    ...
    #   network's ``in_dim`` is unchanged. This is the flashsim
...
class Wan21Transformer(Transformer[Wan21TransformerCache]):
    ...
    def predict_flow(
        ...
        #
        # * ``stamp_image_latent`` (flashsim mask-inject recipe used by
